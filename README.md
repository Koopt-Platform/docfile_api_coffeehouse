          ...
          "payload":  [
             {
                ...
                "working_time": {
                  ...
                  "value": "открыто до 20:00",
                  "access_mode": true (пропускной режим) 
                  "today": { //График работы на текущий день
                    "opening": 1583495005, //откроется 06.03.2020, 16:43:25
                    "closing": 1583500525 //закроется 06.03.2020, 19:05:25
                  },
                  "next": { //График работы на следующий день
                     "opening": 1583673325, //откроется 08.03.2020, 18:15:25
                     "closing": 1583759725 //закроектся 09.03.2020, 18:15:25
                  }
                },
                "active": true (обслуживает ли в данный момент кофейня)
              }
